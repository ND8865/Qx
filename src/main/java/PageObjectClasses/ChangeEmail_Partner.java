...
public class ChangeEmail_Partner {
	
	WebDriver driver;
	MailBox code;
		
		public ChangeEmail_Partner(WebDriver driver) {
			this.driver = driver;
		...
		public boolean validateCancelButtons() {
			try {
				...
				System.err.println("Exception in Class - ChangeEmail_Partner, Method - validateCancelButtons : " + e);
				return false;
			}
		}
		...
		public boolean navigateToSettingPage() {
			try {
				...
				System.err.println("Exception in Class - ChangeEmail_Partner, Method - navigateToSettingPage : " + e);
				return false;
			}
		}
		...
		public boolean navigateToChangePasswordPage() {
			try {
				...
				System.err.println("Exception in Class - ChangeEmail_Partner, Method - navigateToChangePasswordPage : " + e);
				return false;
			}
		}
		...
		public boolean validateEmailFieldChangePasswordPage() {
			try {
				...
				System.err.println("Exception in Class - ChangeEmail_Partner, Method - validateEmailFieldChangePasswordPage : " + e);
				return false;
			}
		}
		 ...
		 */
		public boolean ValidateEmailFieldData(String emailPartner) {
			try {
				WaitClass.waitForTime(1000);
				String fetchedEmail = emailUpdateField.getAttribute("value").trim();
				boolean flag1 = (fetchedEmail).equals(emailPartner);
				return flag1;
			} catch (Exception e) {
				System.err.println("Exception in Class - ChangeEmail_Partner, Method - ValidateEmailFieldData : " + e);
				return false;
			}
		}
		...
		public boolean ValidateEmailFieldChangePopup() {
			try {
				...
				System.err.println("Exception in Class - ChangeEmail_Partner, Method - ValidateEmailFieldChangePopup : " + e);
				return false;
			}
		}
		...
		public boolean validateEmailFieldsValidation(boolean blankEmailField, boolean invalidEmailField) {
			try {
				...
				System.err.println("Exception in Class - ChangeEmail_Partner, Method - validateEmailFieldsValidation : " + e);
				return false;
			}
		}
		 ...
		 */
		public boolean ValidateEmailFieldConfirmButton(String newPartnerEmail) {
			try {
				emailInputfield.sendKeys(newPartnerEmail);
				confirmButton.click();
				WaitClass.waitForTime(3000);
				...
				flag = flag && (newPartnerEmail).equals(verificationPopupEmail.getText());
				return flag;
			} catch (Exception e) {
				System.err.println("Exception in Class - ChangeEmail_Partner, Method - ValidateEmailFieldConfirmButton : " + e);
				return false;
			}
		}
		...
		public boolean validateVerificationCodeValidation(boolean blankCodeField, boolean invalidCode) {
			try {
				...
				System.err.println("Exception in Class - ChangeEmail_Partner, Method - validateVerificationCodeValidation : " + e);
				return false;
			}
		}
		 ...
		 */
		public boolean signinActionPartnerSkip(String username, String password) {
			UserNameField.clear();
			try {
				...
				System.err.println("Exception in Method - signinActionPartnerSkip, Class - ChangeEmail_Partner : " + e);
				return false;
			}
		}
		...
		public boolean ValidateValidVerificationCode(String verificationCode) {
			try {
				...
				System.err.println("Exception in Class - ChangeEmail_Partner, Method - ValidateValidVerificationCode : " + e);
				return false;
			}
		}
