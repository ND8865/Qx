...
public class Change_Password_Partner {
	
	WebDriver driver;
	
	public Change_Password_Partner(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "//button[@data-testid='updateKey']")
	...
	public boolean navigateToChangePasswordPage() {
		try {
			...
			System.err.println("Exception in Class - Change_Password_Partner, Method - navigateToChangePasswordPage : " + e);
			return false;
		}
	}
	...
	public boolean validateAllElementsChangePasswordPage() {
		try {
			...
			System.err.println("Exception in Class - Change_Password_Partner, Method - validateAllElementsChangePasswordPage : " + e);
			return false;
		}
	}
	...
	public boolean validateFieldsValidation(boolean blankFields, boolean invalidCurrentPassword, boolean confirmPasswordMismatch) {
		try {
			...
			System.err.println("Exception in Class - Change_Password_Partner, Method - validateFieldsValidation : " + e);
			return false;
		}
	}
	...
	public boolean changePasswordAction(boolean currentPassword, boolean newAndConfirmPasswordfields, boolean filledAllFields) {
		try {
			...
			System.err.println("Exception in Class - Change_Password_Partner, Method - changePasswordAction : " + e);
			return false;
		}
	}
